    ...
    <div class="full-width breadcrumb" style="margin-bottom: 0;">
        <div class="container">
            <ol class="breadcrumb" style="margin-bottom: 0;">
                ...
                <li class="breadcrumb-item active ml-2"><?= $brand_title; ?></li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        if (!empty($products)):
                            foreach ($products as $pdt):
                                extract($pdt);
                                echo "<article class='col-lg-4 portfolio-item'>";
                            ...
                            echo "<p class='alert alert-info fa fa-warning col text-left'> Nenhum produto cadastrado na(o) Marca/Fabricante <b>$brand_title</b></p>";
                        endif;
                        ?>
                    </div>
                </div>
